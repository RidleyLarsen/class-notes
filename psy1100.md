...
### Play
  * Rough and tumble play
    - Promotes development of the prefrontal cortex. Other juvenile mammals all have play.
  * Fantasy play
...
### Parenting Styles
  * Authoritative:
    - High nutrition, high limits
    - Sometimes will break own rules for children
    - Flexible parenting
    - Disciplining by helping children realize their mistakes instead of using power over them.
  * Authoritarian:
    - High limit, low nutrition.
    - Authoritarian rhymes with barbarian.
    - Only cares about obedience, not good people
    - Disciplining with power exertion.
  * Permissive:
    - Low limits, high nutrition.
    - Giving anything without really caring what the effects are.
  * Neglective
    - Low limit, low nutrition
    - Not caring for children at all.

### Bullying
  * Characteristics of bullied children
    - 10% of children
    - Naturally awkward children
    - Rejected by parents, peers, mentors.
    - Causes the most severe psychological damage.
  * Characteristics of child bullies
    - Generally have authoritarian parents.
    - Parents using power-exertion discipline.
...
### Intelligence
  - Cognitive tasks
  - Property of mind and activities in the brain
  - Intelligence tests - Testing intelligence. Some good, but information not great to extrapolate from.
  - Achievement tests - Testing being able to do something.
  - 70 IQ clinical diagnosis of retardation
  - Learning disabilities
    - Dyslexia

  * IQ tests: reliable and validity.
    - Reliable
...
### *Howard Gardner*: "G" and Triarchic theory aren't enough. Also we need to consider
  - Mathmatical intelligence
  - Interpersonal intelligence
  - Verbal: reading writing speaking language
  - Spatial: navigation, directions, object rotations
  - Kinesthetic: Physical body ability. Sports, instruments, star craft actions per minute
  - Naturalist: Understanding of natural world. plants, animals, zoology/biology, etc.
...
### Motivations
  - Intrinsic motivation: You're interested in something and it comes from inside.
  - Extrinsic motivation: External motivations (grades, money, etc.)
  - Has links with little scientist phase.
...
### Formal operational thinking (Adolescence)
  * Youth thinking abstractly, using scientific process and hypothetical situations.
...
# Nov 10, 2015
  * Emerging Adulthood (18-24, usually)
    - On Time (early 20s) or Off Time (either early or late)
    - Leaving home
...
# Nov 12, 2015
  * Western culture says you have to be in love to get married (past 100 years)
    - That is not always true; there are other cultures that don't have that- think arranged marriage, etc.
  * Adult Attachment Styles
    - Not based on parent relationship.
    - Preoccupied/Ambivalent - Clingy, high anxiety, never get enough love from spouse.
    - Avoidant/dismissive - High avoidance, low anxiety. Hard to get into relationships/standoffish. Partner feels like they don't give enough love or are a part of the relationship.
    - Fearful/Avoidant - High avoidance, High Anxiety. Afraid of relationships, but if something happens they'll break it off.
    - Securely attached. - Low avoidance, low anxiety. Open, don't demand all their time but flexibility and reliability exists. Empathy, caring, satisfaction.

Extra Credit: www.yourpersonality.net pick any 3 tests on attachment. write one page cover sheet. 4 sheets total. what you did & what you learned. Due by 19th.
...
### Marriage
  ...
  * Marriage
    - Disenchantment with partner & marriage (disillusionment)
    - U-shaped curve of marital satisfaction (Cross-sectional: happiness & satisfaction is u-shaped, with the lowest point being where parents are raising teenagers.)
    - Continuous decline* (longitudinal research suggests there is a continuous decline in happiness & satisfaction.)

### Love
  * Triangular theory of love
    - Passion: Physiological, chemical process. Neurochemicals acting in full-force.
    - Intimacy: Increases with time as passion falls.
    - Commitment: Increases slowly over time.
    - Consummate love: Has passion, intimacy, and commitment.
    - Companionate marriages: Intimacy and Commitment, but not necessarily passionate. The couple are friends and have psychological connection.

### Communication
  * Positive to negative interactions
    - For every negative interaction, you need to do 5-7 positive things. (Disregarded feelings -> Bring flowers, give hug, etc.)
  * Stick to the problem, not the person
    - When you have diagreements, don't blame or insult the other person. Deal with the problem, without saying things like "you always do <thing>"
  * Avoid demand-withdrawal
    - Women tend to demand communication more ("we need to talk", eg.) and men tend to withdraw. This is a communication anti-pattern.
  * Avoid suspicion
    - Give your partner the benefit of the doubt. We treat our friends, family, acquaintances far nicer than our romantic partners.
    - "You were texting late last night. Are you cheating on me?"

### Ways of Being together
  * Communal model of love
    - Each person gives 100% of the relationship. If a partner has a need, they try to take care of it. They want to contribute as much as they can.
    - Housework split evenly, money combined, etc.
  * Exchange model of love
    - Each person contributes 50%. When each partner is expected to contribute 50%, couples tend to keep track of who is behind on the score.

### Divorce
In the process, partners tend to feel like they aren't in love any more, or that they were never truly in love.
...
### Parenthood
  * Fertility rates
    - Amount of children an average woman will have over her lifetime. The average in the USA has dropped from 2-3 to 1-2.
  * Transition
    - Decrease in intimacy and romance.
      * Higher levels of oxytocin after having baby
      * Sleep depravation
      * Jealousy of new baby taking all the wife's attention
    - Traditional roles (and conflict)
      - Marital equality. Seems more unfair that women have more responsibilities in a relationship with children. They have to create the baby and then traditional gender roles can naturally start occurring.
      * Conflict occurs in every single relationship with children, even in well-off relationships that don't have money or work trouble.
      * People need social support in a relationship. They say it takes two people to make a baby, and a village to raise them.

### Motherhood
  * Emotions
    - Motherhood is very stressful because there are no breaks, no days off. Being a 24/7 primary caregiver takes a lot of work.
    - Eg. trying to put a toddler down for a nap, but starts crying, newborn starts crying, mother starts crying.
  * Expectations
    - Many mothers feel like they have the expectation that they have to be perfect, or that anything they do will be wrong or effect the child's development negatively.
  * Partner support
    - Mothers need support while raising a child because it is insanely stressful.

### Fatherhood
  * Gender differences
    - If a father has a son, he will on average be more invested in the relationship and the son's success.
    - If a father has a daughter or only has daughters, fathers on average are more likely to leave or not be invested in success.
  * Play
    - Fathers tend to engage in more play with children; part of that comes from society's "traditional" gender roles where the mother does chores and the father goes to work, comes home, and gives the mom a break by playing with the kids.
  * "Gatekeeping"
    - In our society women tend to be the gatekeepers- they are expected to make the decisions about and for children.
  * Individual differences
    - There are infinitely many ways to raise a child. It is a complex task and can't be modeled or explained easily.
  * Partner support
    - Males on average are expected to take care of financial support.

## Extra Credit Opportunity
  * Write about your adulthood, midlife, old age, and death.
  * Use concepts from the text
  * Be thoughtful and somewhat realistic
  * Typewritten
  * 2-3 Pages
...
### Grandparents
  ...
  * Family watchdogs
  * Caregiving grandparents - Grandparents take care of children instead of putting them in foster care.

### Midlife
  * Parent care - Adults providing caregiving for their parents. Kind of like a generational sandwich - taking care of children as well as parents is a difficult task.
  * Intergenerational solidarity - "loving obligation"
  * Sex, etc.
  * Men
  * Women - more confident and comfortable with sexuality in midlife
    - Menopause: age related process where menstration and ovulation stop because of a loss of estrogen. Humans are the only animals who have menopause.
    - Perimenopause: Women missing periods as a pre-menopausal symptom. Menopause officially starts when a woman misses 12 consecutive periods. This stage includes changes in mood, hot flashes and night sweats, greater anxiety and depression,
  * Individual differences - Some women experience menopause with no problems at all, some have great trouble.

### Later Life
  * Increased life expectancy
    - Median age is increasing. In the US, the median age is 38. China: 36, Japan: 45, Canada: 45, Italy: 52.
    - Later life expectancy: If you make it to 65, you have a 50% chance of living an extra 20 years.
      - Young old: People in 60s and 70s
      - Old old: People in 80s - 100s
      - Oldest old: Living beyond 100s. Biology suggests it is physically impossible to live past 122.

### Evolving Self
  * Memory
    - Not all older people have memory problems. Many have full faculty of their memory and can recall as well as younger people. On average, older people do perform worse than younger people in memory tasks, though.
    - Memory-systems perspective: Three different types of memory that function differently through the life.
    - Procedural memory: Longest-lasting type of memory. Remembering how to do things like doing a zipper, chewing and swallowing, etc. These are behavioral processes; you don't actively think about chewing and swallowing.
    - Semantic memory: In-between memory. Ability to recall basic facts, like who the president is, what year you were born, etc.
    - Episodic memory: First memory to go with age. Recalling activities of daily life. "What happened on Sunday at 2 pm?"

### Memory Interventions
  * Selective Optimization with Compensation
    - Anecdote of mother-in-law where she would use a calendar to buy birthday cards for people well in advance instead of remembering all the birthdays and holidays, etc.
  * Mnemonic techniques: Using imagery or enhancing the emotional memory of things to create additional meaning. e.g. PEMDAS.
  * Memory self-efficacy: How you think of your memory will predict how your actual memory works. If you feel like you have poor memory, you will have poorer memory. It's like "the secret" except real.
